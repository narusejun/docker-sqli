<?php
	...
	*/
	...
	if(isset($_POST["username"]) && isset($_POST["password"])){
		...
		if(strlen($_POST["password"]) > 2) throw new Exception("length of password > 2");
		
		$db = new PDO("mysql:host=127.0.0.1;dbname=p18", "p18");
		...
		if($row = $result->fetch()){
			...
			if($row["Username"] === "admin"){
				$message .= "<br><br>Good job! FLAG is FLAG_a401ff881709171f62ab7859fd74246cdddccc07";
			}
		}else{
